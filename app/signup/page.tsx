...
import { Eye, EyeOff, Mail, Lock, Building, User, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-6">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Welcome to VervidFlow!</h1>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            Start your 14-day free trial with VervidFlow
          </motion.p>
        </div>
