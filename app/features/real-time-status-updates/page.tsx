...
export default function RealTimeStatusUpdatesPage() {
  return (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-darkCard p-6 rounded-xl border border-neutral-800 hover:border-primary/40 transition-colors duration-300">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Service Started</h3>
              <p className="text-neutral-200">Customers receive updates when their service request begins processing.</p>
            </div>
            <div className="bg-darkCard p-6 rounded-xl border border-neutral-800 hover:border-primary/40 transition-colors duration-300">
              <FaCar className="text-3xl text-primary mb-4" />
              <h3 className="text-xl font-semibold text-white mb-3">Progress Updates</h3>
              <p className="text-neutral-200">Live updates as work progresses with detailed status information and milestones.</p>
            </div>
            <div className="bg-darkCard p-6 rounded-xl border border-neutral-800 hover:border-primary/40 transition-colors duration-300">
