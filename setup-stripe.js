...
console.log('🔥 VervidFlow Stripe Setup Script');
console.log('=====================================\n');
...
console.log('   - VervidFlow Basic: $29/month');
console.log('   - VervidFlow Professional: $79/month');
console.log('   - VervidFlow Enterprise: $149/month');
